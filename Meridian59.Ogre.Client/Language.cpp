...
{
   "No error.",                                                                                                                                                                   // 0
   "Character creation failed due to an unspecified error, please try again and contact an admin in-game or at Meridian 59 Server 420 Discord if you are unable to create a character.", // 1
   "Character slot already in use! Please try a different character slot, and contact an admin in-game or at Meridian 59 Server 420 Discord.",                                           // 2
...
{
   "Kein Fehler.",                                                                                                                                                                                                                                     // 0
   "Charaktererstellung aufgrund eines unspezifizierten Fehlers fehlgeschlagen, bitte versuche es erneut und kontaktiere einen Administrator im Spiel oder auf Meridian 59 Server 420 Discord wenn Du nicht in der Lage bist, einen Charakter zu erstellen.", // 1
   "Charakterplatz bereits belegt! Bitte versuche einen anderen Charakterplatz und kontaktiere einen Administrator im Spiel oder auf Meridian 59 Server 420 Discord.",                                                                                        // 2
